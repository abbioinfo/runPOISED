...
nlandMarks = 10 		## number of landmarks cells you need from each cell type. [default 10] good enough for most studies; higher values means more neighbouring cells; improves training but reduce execution speed 
