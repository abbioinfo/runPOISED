...
If you are wondering, how we generated expected cell labels of FCS files, then cells are labels are generated by matching the cells of live cells to the mangally gated cell populations using following scripts.
